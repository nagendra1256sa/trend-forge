export const paths = {
	...
	dashboard: {
		overview: "/dashboard",
		bcDetails: "organisation-hierarchy/dashboard-route",
		reportsOverview: "organisation-hierarchy/dashboard-route",
		settings: {
	...
	taxRule: {
		getTaxRules : () => `tax-rules`,
      getTaxRulesByBcID : (bcId: number) => `bc-products/${bcId}/taxrules`,
	...
	paymentconfigurations:'/payment-configurations',
	menuitems:'/client-engagement',
